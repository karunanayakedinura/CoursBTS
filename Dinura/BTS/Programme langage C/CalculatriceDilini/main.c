...
int main()
{
    ...
    while (boucle == 1)
        ...
        case '+' : printf("La somme de : %.2f + %.2f = %.2f .\n", nombre1, nombre2, nombre1+nombre2);
            break;
            case '-' : printf("La diference de : %.2f .\n", nombre1-nombre2);
            break;
            case '*' : printf("Le produit de vos 2 nombres est egale a %.2f .\n", nombre1*nombre2);
            break;
            case '/' : printf("La division de a %.2f .\n", nombre1/nombre2);
            break;
            case 'm' :
                if (nombre1<nombre2)
        ...
        printf("Voulez vous refaire un autre calcul? ('1' pour effectuer un autre calcul et '0' pour arreter.)\n");
        scanf("%d",&boucle);
        }
